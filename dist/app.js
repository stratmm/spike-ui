...
module.exports = Marionette.ItemView.extend({
  ...
  tabClicked: function(event) {
    ...
    return Commands.execute("src/app/views/products/edit/layout/show_tab", tab.data('tab-name'));
  }
});
